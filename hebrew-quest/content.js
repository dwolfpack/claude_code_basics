...
function buildRhymeMatchGrade1() {
  ...
  // the child must recall each picture's word and judge the rhyme by ear.
  const items = [
    { word: 'יד', speakWord: 'יד', correct: '🏺', options: ['🏺', '❤️', '🌳', '🐟'] },   // יד~כד
    { word: 'נחש', speakWord: 'נחש', correct: '🍯', options: ['🍯', '🏺', '🌳', '✋'] },  // נחש~דבש
    { word: 'אור', speakWord: 'אור', correct: '🐦', options: ['🐦', '❤️', '🐟', '🗣️'] }, // אור~ציפור
    { word: 'חול', speakWord: 'חול', correct: '🗣️', options: ['🗣️', '🌳', '🐦', '🍯'] }, // חול~קול
    { word: 'כד', speakWord: 'כד', correct: '✋', options: ['✋', '🐍', '💡', '🐦'] },     // כד~יד
    { word: 'שן', speakWord: 'שן', correct: '👦', options: ['👦', '🏺', '🌳', '🐍'] },    // שן~בן
    { word: 'חם', speakWord: 'חם', correct: '👉', options: ['👉', '❤️', '🐟', '✋'] },     // חם~שם
    { word: 'עיר', speakWord: 'עיר', correct: '🎤', options: ['🎤', '🍯', '🦷', '🐦'] },  // עיר~שיר
  ];
  return items.map(it => ({
    emoji: '🎵',
    question: 'הקשיבו למילה - איזו תמונה מתחרזת איתה?',
    options: it.options,
    answer: it.correct,
    speak: it.speakWord,
  }));
...
function buildIdiomsGrade5() {
  const items = [
    ...
    { idiom: 'לשבת על הגדר', answer: 'להיות לא מוחלטים ולא לבחור צד', options: ['להיות לא מוחלטים ולא לבחור צד', 'לשבת בחוץ בגינה', 'לטפס על עץ גבוה', 'לבנות גדר חדשה'] },
    { idiom: 'לעשות מהעכבר הר', answer: 'להגזים בבעיה קטנה', options: ['להגזים בבעיה קטנה', 'לפחד מעכברים', 'לבנות הר גבוה', 'לתפוס עכבר בבית'] },
    { idiom: 'להיות בעניינים', answer: 'להיות מעודכנים ופעילים', options: ['להיות מעודכנים ופעילים', 'להיות עסוקים מדי', 'לא להתעניין בכלום', 'לדבר על עצמם'] },
  ];
  return items.map(it => ({
    emoji: '💬',
...
function buildReadingGrade5() {
  const passages = [
    {
      text: `הַקִּנָּמוֹן: תַּבְלִין עִם הִיסְטוֹרְיָה
לִפְנֵי אַלְפֵי שָׁנִים, סוֹחֲרִים מֵהַמִּזְרָח הָרָחוֹק שָׁטוּ בִּסְפִינוֹת כְּדֵי לְהָבִיא קִנָּמוֹן לְאַרְצוֹת הַיָּם הַתִּיכוֹן. הַקִּנָּמוֹן הוּפַק מִקְּלִפַּת עֵץ מְיֻחָד שֶׁגָּדַל בְּאִיִּים רְחוֹקִים, וְהָיָה יָקָר כָּל כָּךְ עַד שֶׁנֶּחְשַׁב לְמַתָּנָה רְאוּיָה לַמְּלָכִים. הַדֶּרֶךְ הָיְתָה אֲרֻכָּה וּמְסֻכֶּנֶת, וְלָכֵן מְעַט אֲנָשִׁים יָדְעוּ בֶּאֱמֶת מֵאַיִן הוּא מַגִּיעַ. הַיּוֹם, קִנָּמוֹן גָּדֵל בִּמְקוֹמוֹת רַבִּים בָּעוֹלָם, וְאֶפְשָׁר לִמְצֹא אוֹתוֹ כִּמְעַט בְּכָל מִטְבָּח. הוּא מְשַׁמֵּשׁ לְתַבְלוּן עוּגוֹת, מַשְׁקָאוֹת חַמִּים וַאֲפִלּוּ תַּבְשִׁילִים מְלוּחִים.`,
    ...
    {
      text: `דְּבוֹרִים: הַבּוֹנוֹת הַחֲרוּצוֹת
דְּבוֹרִים הֵן חֲרָקִים קְטַנִּים שֶׁחַיִּים בְּכַוֶּרֶת גְּדוֹלָה, יַחַד עִם אַלְפֵי דְּבוֹרִים אֲחֵרוֹת. בְּכָל כַּוֶּרֶת יֵשׁ מַלְכָּה אַחַת בִּלְבַד, שֶׁתַּפְקִידָהּ לְהַטִּיל בֵּיצִים. שְׁאָר הַדְּבוֹרִים עוֹבְדוֹת כָּל הַיּוֹם: הֵן טָסוֹת מִפֶּרַח לְפֶרַח, אוֹסְפוֹת צוּף וּמְבִיאוֹת אוֹתוֹ הַבַּיְתָה. בְּתוֹךְ הַכַּוֶּרֶת, הַדְּבוֹרִים הוֹפְכוֹת אֶת הַצּוּף לִדְבַשׁ מָתוֹק, שֶׁשּׁוֹמְרוֹת אוֹתוֹ לְמַאֲכָל בַּחֹרֶף. דְּבוֹרִים גַּם עוֹזְרוֹת לַצְּמָחִים לִגְדֹּל, כִּי כְּשֶׁהֵן עָפוֹת מִפֶּרַח לְפֶרַח הֵן מַעֲבִירוֹת אַבְקָה בֵּינֵיהֶם. בְּלִי דְּבוֹרִים, הַרְבֵּה פֵּרוֹת וִירָקוֹת לֹא הָיוּ יְכוֹלִים לִגְדֹּל.`,
      questions: [
        { q: 'כמה מלכות יש בכל כוורת?', answer: 'רק אחת', options: ['רק אחת', 'שתיים', 'חמש', 'אין בכלל'] },
        { q: 'ממה מכינות הדבורים את הדבש?', answer: 'מצוף פרחים', options: ['מצוף פרחים', 'ממים', 'מעלים', 'מאבקה'] },
        { q: 'למה חשובות הדבורים לצמחים?', answer: 'הן מעבירות אבקה בין פרחים', options: ['הן מעבירות אבקה בין פרחים', 'הן שותות את המים שלהם', 'הן אוכלות את העלים', 'הן בונות להם בית'] },
        { q: 'למה שומרות הדבורים דבש?', answer: 'כדי לאכול אותו בחורף', options: ['כדי לאכול אותו בחורף', 'כדי למכור אותו', 'כדי לצבוע את הכוורת', 'כדי לתת אותו למלכה בלבד'] },
      ],
    },
  ];
  ...
  const questions = [
    { type: 'intro', emoji: '📖', text: passage.text },
    ...passage.questions,
  ];
...
function buildWordRiddlesGrade5() {
  const items = [
    { riddle: 'אני חיה גדולה עם חדק ארוך. מי אני?', answer: 'פיל', options: ['פיל', 'אריה', 'נמר', 'דוב'] },
    { riddle: 'אני עולה בשמיים בלילה ומאירה באור כסוף. מי אני?', answer: 'ירח', options: ['ירח', 'שמש', 'כוכב', 'ענן'] },
    { riddle: 'יש לי שני גלגלים, פדלים וכידון. מי אני?', answer: 'אופניים', options: ['אופניים', 'קורקינט', 'מכונית', 'רכבת'] },
    { riddle: 'אני פרי צהוב וארוך שקופים אוהבים לאכול. מי אני?', answer: 'בננה', options: ['בננה', 'תפוח', 'ענב', 'תפוז'] },
    { riddle: 'יש לי ארבע רגליים, זנב, ואני נובח. מי אני?', answer: 'כלב', options: ['כלב', 'חתול', 'סוס', 'ארנב'] },
    { riddle: 'אני עונת השנה החמה ביותר בשנה. מי אני?', answer: 'קיץ', options: ['קיץ', 'חורף', 'אביב', 'סתיו'] },
    { riddle: 'אני המקום שבו תלמידים לומדים כל יום. מי אני?', answer: 'בית ספר', options: ['בית ספר', 'בית חולים', 'ספרייה', 'מוזיאון'] },
    { riddle: 'יש לי כנפיים אך אינני עוף - אני חרק צבעוני. מי אני?', answer: 'פרפר', options: ['פרפר', 'דבורה', 'יתוש', 'נמלה'] },
  ];
  return items.map(it => ({
    emoji: '❓',
    question: it.riddle,
...
function buildSentenceUnscrambleGrade5() {
  ...
  const sentences = [
    ...
    'החתול ישן על הכיסא הרך',
    'אנחנו הולכים לים בקיץ',
    'אבא בישל ארוחה טעימה',
  ];
